...
% v7 - REP check on hist_E_Mqp1 and failsafe DOS = 0
%
clear
close all
%
...
skip = N_atm;
%
JDOS_filename = ['JDOS_FSS_spinS_Ising_v7_Npos', int2str(Npos), '_', dim, '_', lattice_type, '_L', int2str(L), '_REP_1E', int2str(log10(REP)), '_skip_', int2str(skip)];
%
disp([datestr(now,'dd/mm/yyyy HH:MM:SS'), ' | start run of ', 'FSS_spinS_Ising_v7_Npos', int2str(Npos), '_', dim, '_', lattice_type, '_L', int2str(L), '_REP_1E', int2str(log10(REP)), '_skip_', int2str(skip)]);
%
