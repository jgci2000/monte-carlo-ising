...
// Output location
#define SAVE_DIR(lattice, L, log_REP)    "./data/fss_Ising/" + lattice + "/L" + to_string(L) + "/" + to_string(log_REP) + "/"
...
int main(int argc, char **argv)
{
    ...
    if (rank == root)
    {
        ...
        string console_output_2 = "shuffle: " + to_string(shuffle_REP) + " | workers: " + to_string(size) + " | REP/worker: " + 
